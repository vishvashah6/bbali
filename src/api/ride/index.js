...
import { createReview, create, index, show, update, destroy, unlockQR, start, lock,end, history,index1} from './controller'
import { rSchema } from './model'

export Ride, { rSchema } from './model'

const router = new Router()
const {rideId, vehicleName, userLat, userLon, starRating, textRating} = ''
